...
Esse foi o último projeto elaborado durante o Módulo de __Back-end__ , porém, para ser desenvolvido com os conteúdos __Full Stack__ , utilizando a maior parte dos conteúdos vistos ao longo do curso. Além disso, existiu a opção desse projeto ser feito em grupo para quem quisesse desenvolver o processo de colaboração. <br>
<br>
...
1. Clone o repositório com o comando: `git clone git@github.com:aimemartins/project-delivery-app.git`
2. Entre na pasta do repositório que você acabou de clonar: `cd project-delivery-app`
...
## Status
O projeto está com 90% dos requisitos totais finalizados
